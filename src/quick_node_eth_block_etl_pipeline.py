...
class QuickNodeEthBlockETLPipeline:
    ...
    def blocks_to_dto(
        ...
        for single_block in input:
            eth_block_dto: EthBlockDTO = (
                EthBlockDTO.from_quick_node_block_information_response(single_block)
            )
            ...
            for single_transaction in single_block.result.transactions:
                eth_transaction_dto: EthTransactionDTO = (
                    EthTransactionDTO.from_quick_node_eth_transaction(
                ...
                single_transaction_eth_access_list_items: list[
                    ...
                    [
                        EthTransactionAccessListDTO.from_quick_node_eth_access_list_item(
