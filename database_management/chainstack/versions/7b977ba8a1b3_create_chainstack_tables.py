"""Create chainstack tables

Revision ID: 7b977ba8a1b3
Revises: 
Create Date: 2025-03-02 09:59:00.050086
...
def upgrade() -> None:
    ...
    op.create_table('eth_block_import_status',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('block_number', sa.Integer(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index('block_number_index', 'eth_block_import_status', ['block_number'], unique=False, postgresql_using='btree')
    ...
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['block_number'], ['eth_blocks.block_number'], name='transactions_to_blocks_fk'),
    sa.PrimaryKeyConstraint('hash')
    )
    op.create_table('eth_withdrawals',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('block_number', sa.String(), nullable=False),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['block_number'], ['eth_blocks.block_number'], name='withdrawals_to_blocks_fk'),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade() -> None:
    ...
    op.drop_index('block_number_index', table_name='eth_block_import_status', postgresql_using='btree')
